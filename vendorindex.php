...
<html lang="en">
	...
	<body>
			...
			<section class="presentation">
				<div class="introduction">
					<div class="intro-text">
						...
						<h1>Welcome <?php echo $_SESSION['vusername'];?></h1>
						<?php endif?>
						<p>
		...
		<section>
			<div class="intro-text">
				<h1>Add to our catalogue</h1>
				<p>Add your own arsenal of products to sell to the site!</p>
			</div>
			<div class="row" >
				<div class="column">
		  ...
		  <footer id="footer" data-aos="fade-up"  data-aos-offset="200" data-aos-duration="1000">
			<div class="main-content">
			  ...
			  <div class="right box">
				<h2>Contact us</h2>
				<div class="content">
				  <form action="vendorindex.php" method ="post">
					<div class="email">
			...
			<div class="bottom">
			  <center>
				...
				<span class="credit"> <a href="vendorindex.php?logout='1'">Logout</a></span>
			  </center>
			</div>
		  </footer>
	   </section>
